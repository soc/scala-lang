...
A singleton object can extend classes and traits. In fact, a [case class](case-classes) with no [type parameters](generic-classes) will by default create a singleton object of the same name, with a [`Function*`](http://www.scala-lang.org/api/current/scala/Function1.html) trait implemented.
